...
class SSL_Finetune(BaseLearner):
    ...
    def _init_train(self, labeled_trainloader, unlabeled_trainloader, test_loader, optimizer, scheduler,ema_model):
        ...
        for epoch in range(200):
            ...
            #test_loss, test_acc= self._test(test_loader, test_model, epoch)

            # model_to_save = self._network.modules() if hasattr(self._network.modules(), "module") else self._network.modules()
